<%@ Page Title="" Language="C#" MasterPageFile="~/PMRecicladoBotellas.Master" AutoEventWireup="true" CodeBehind="ListadoGramos.aspx.cs" Inherits="WASimuladorSiu.Forms.ListadoGramos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <fieldset>
        ...
        <table class="tabla">
            <tr>
                <td>
                    <asp:Label CssClass="lblFecha" runat="server" Font-Bold="True" Text="Buscar por fecha:" Visible="false"></asp:Label>
                    <asp:TextBox ID="txtBusquedaFecha" TextMode="Date" CssClass="txtFecha" runat="server" Visible="false"></asp:TextBox>
                </td>
                <td>
                    <asp:Label CssClass="lblHora" runat="server" Font-Bold="True" Text="Buscar por hora:" Visible="false"></asp:Label>
                    <asp:TextBox ID="txtBusquedaHora" CssClass="txtHora" TextMode="Time" runat="server" Visible="false"></asp:TextBox>
                </td>
            </tr>
        </table>
