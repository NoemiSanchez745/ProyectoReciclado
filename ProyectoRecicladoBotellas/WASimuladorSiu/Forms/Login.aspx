<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WASimuladorSiu.Forms.Login" %>
                        ...
                        <tbody>
                            <tr>
                                <td style="background-color: #2A2A2A; width: 5px;">
                                    <img id="imgLeftTop" src="./Servicio de autenticación Netvalle_files/Center5x5.png">
                                </td>
                                                        ...
                                                        <table style="border-width: 0px; width: 99%;">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="auto-style1">
                                                                        <asp:TextBox runat="server" ID="txtPIN" Style="width: 88%;"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td align="left" class="auto-style1">
                                                                        <asp:DropDownList ID="ddlSelectUser" runat="server" Style="width: 90%;" AutoPostBack="true">
                                                                            ...
                                                                            <asp:ListItem Value="ES">Estudiante Extranjero</asp:ListItem>
                                                                            <asp:ListItem Value="EU">Estudiante</asp:ListItem>
                                                                            <asp:ListItem Value="DC">Director de Carrera</asp:ListItem>
                                                                            <asp:ListItem Value="DE">Director de Educación Internacional y relaciones</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <div align="center" id="botones" style="font: normal 8px/4px verdana; width: 120px">
                                                                                            <asp:ImageButton ID="Btn1" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/1.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn2" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/2.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn3" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/3.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn4" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/4.png" />&nbsp;<br />
                                                                                            <br />
                                                                                            <asp:ImageButton ID="Btn5" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/5.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn6" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/6.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn7" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/7.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn8" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/8.png" Width="19px" />&nbsp;<br />
                                                                                            <br />
                                                                                            <asp:ImageButton ID="Btn9" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/9.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="Btn0" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/0.png" />&nbsp;
                                                                                           
                                                                                            <asp:ImageButton ID="BtnLimpiar" alt="" runat="server" ImageUrl="./Servicio de autenticación Netvalle_files/Limpiar.png" />&nbsp;
